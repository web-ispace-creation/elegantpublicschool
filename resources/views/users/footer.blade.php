    ...
    <div class="container">
        <footer class="row  py-5 border-top">
            ...
            <div class="col-12 col-md-4 mb-3 text-center text-md-start">
              <h5 class="text-light fw-normal">Get in touch</h5>
              <ul class="nav flex-column mt-3">
                <small><li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light fw-normal small"><i class="bi bi-geo-alt-fill text-el-orange h6"></i> Market Road Palakkad, 678014</a></li></small>
                <small><li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light fw-normal small"><i class="bi bi-telephone-fill text-el-orange h6"></i> +91 491-2000030</a></li></small>
                <small><li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-light fw-normal small"><i class="bi bi-envelope-fill text-el-orange h6 "></i> theelegantpublicschool@gmail.com</a></li></small>
              </ul>
            </div>
          </footer>
          <div class="text-center mx-auto pb-3">
            <small class="text-light">Copyrights © 2023 The Elegant Public School. All rights reserved.</small>
          </div>
